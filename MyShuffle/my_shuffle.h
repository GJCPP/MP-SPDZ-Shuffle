...
namespace myShuffle {
    ...
    */
    ...
    public:
        ...
        std::vector<ShareType> c, d; // Terminal Verify correlations for parties 1, ..., n - 1.
    ...
    */
    ...
    // Algorithm 3: verify every retained intermediate message and the final
    // broadcast together, then reveal one authenticated blinded residual.
