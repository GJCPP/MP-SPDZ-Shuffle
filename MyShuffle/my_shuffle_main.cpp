...
int python_interface(int argc, char **argv) {
    if (argc != 9) {
        ...
        std::cerr << "\tprotocol: my_shuffle, Song_shuffle, Chase_shuffle, semi_my_shuffle, test_my_shuffle, test_my_shuffle_tamper, test_semi_my_shuffle" << std::endl;
        return 2;
    }
    ...
    if (strcmp(argv[1], "my_shuffle") == 0) {
        ...
        protocol = 6;
    } else if (strcmp(argv[1], "test_my_shuffle_tamper") == 0) {
        protocol = 7;
    } else {
